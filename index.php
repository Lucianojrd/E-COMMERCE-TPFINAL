	...
	<body>
		<nav class="navbar navbar-expand-lg navbar-dark p-3 bg-danger" id="headerNav">
          ...
          <span class="navbar-toggler-icon"></span>
            ...
            ?>
									...
									<li class="nav-item usuarionav">
										<p>
											<img src="imagenes/usuario.png" alt="" width="45px">
      ...
      ?>
		...
		<footer class="text-center text-black">
			...
			<section class="mb-4">
				<!-- Facebook -->
				<a class="btn btn-link btn-floating btn-lg text-dark m-1" href="#!" role="button" data-mdb-ripple-color="dark"><i class="fab fa-facebook-f">Facebook</i></a
        >
        <!-- Instagram -->
        <a
